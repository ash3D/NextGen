...
namespace Renderer
{
	...
	class RenderOutput
	{
		...
		Impl::TrackedResource<ID3D12Resource> rendertarget, ZBuffer, HDRSurfaces[2], LDRSurface, DOFOpacityBuffer, COCBuffer, dilatedCOCBuffer, halfresDOFSurface, DOFLayers, lensFlareSurface, bloomUpChain, bloomDownChain;
