...
namespace Renderer
{
	...
	namespace Impl
	{
		...
		protected:
			...
			void Render(ID3D12Resource *output, ID3D12Resource *rtMSAA, ID3D12Resource *ZBuffer, ID3D12Resource *ZBufferMSAA, const D3D12_CPU_DESCRIPTOR_HANDLE rtvMSAA, const D3D12_CPU_DESCRIPTOR_HANDLE dsv, const D3D12_CPU_DESCRIPTOR_HANDLE dsvMSAA, UINT width, UINT height) const;
